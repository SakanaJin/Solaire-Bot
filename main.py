...
gen_files = ['user-monuments.json', 'dungeon.json', 'user-stocks.json', 'user-skills.json', 'user-mons.json', 'user-inventories.json', 'shop.json', 'quotes.json', 'gaol.json', 'data.json', 'battles.json', 'stocksdata.json']
